...
public interface OntologyService  {
	...
	/**
	 * Auto complete the query with terms in the specified ontologies. 
	 * Return only max number of results.
	 *
	 * @param sessionId an id which can be used to retrieve the session object.
	 * @param query
	 * @param ontologies
	 ...
	 */
	public JsonTermSuggestion[] autocomplete(String sessionId, String query, String[] ontologies, int max);
}
