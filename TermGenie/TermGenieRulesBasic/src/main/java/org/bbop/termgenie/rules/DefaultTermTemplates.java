...
public class DefaultTermTemplates {
	...
	private TermTemplate create(Ontology correspondingOntology, String name, String description, String rules,
			TemplateField...fields) {
		return create(correspondingOntology, name, description, null, rules, fields);
	}
	
	private TermTemplate create(Ontology correspondingOntology, String name, String description, String hint, String rules,
			TemplateField...fields) {
