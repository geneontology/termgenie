...
public class HumanPhenotypePatterns extends Patterns {
	...
	/*
	 * requires
	 * http://compbio.charite.de/svn/hpo/trunk/human-phenotype-ontology_xp.obo
	 */
	@ToMatch
	protected List<TermGenerationOutput> hpo_entity_quality(TermGenerationInput input,
			Map<String, OntologyTerm> pending)
	{
		...
		String definition = createDefinition("Any " + name(e, fma) + " that is  " + name(q, pato) + ".",
				input);
