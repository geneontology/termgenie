...
public class HardCodedTermGenerationEngine implements TermGenerationEngine {
	...
	@Inject
	HardCodedTermGenerationEngine(MultiOntologyTaskManager manager,
			...
			ReasonerFactory factory)
	{
		...
		patterns.put(templates.GENE_ONTOLOGY.getUniqueName(),
				new PatternInstance(manager, factory, GeneOntologyComplexPatterns.class, templates, templates.GENE_ONTOLOGY, templates.PROTEIN_ONTOLOGY, templates.UBERON_ONTOLOGY, templates.PLANT_ONTOLOGY));
		patterns.put(templates.HP_ONTOLOGY.getUniqueName(),
				new PatternInstance(manager, factory, HumanPhenotypePatterns.class, templates, templates.HP_ONTOLOGY, templates.FMA_ONTOLOGY, templates.PATO));
		patterns.put(templates.OMP.getUniqueName(),
				new PatternInstance(manager, factory, MicrobialPhenotypePatterns.class, templates, templates.OMP, templates.GENE_ONTOLOGY, templates.PATO));
		patterns.put(templates.CELL_ONTOLOGY.getUniqueName(),
				new PatternInstance(manager, factory, CellOntologyPatterns.class, templates, templates.CELL_ONTOLOGY, templates.UBERON_ONTOLOGY, templates.PROTEIN_ONTOLOGY, templates.GENE_ONTOLOGY));
		patterns.put(templates.UBERON_ONTOLOGY.getUniqueName(),
				new PatternInstance(manager, factory, UberonPatterns.class, templates, templates.UBERON_ONTOLOGY));
	}
	...
	private static class PatternInstance {
		...
		PatternInstance(MultiOntologyTaskManager manager,
				ReasonerFactory factory,
				Class<? extends Patterns> c,
				DefaultTermTemplates templates,
				Ontology...ontologies)
		{
		...
		List<TermGenerationOutput> run(final Ontology ontology,
				final List<TermGenerationInput> generationTasks)
		{
		...
		private static class TermGenerationMultiOntologyTask extends MultiOntologyTask {
			...
			public TermGenerationMultiOntologyTask(Class<? extends Patterns> c,
					DefaultTermTemplates templates,
					Ontology ontology,
					List<TermGenerationInput> generationTasks,
					ReasonerFactory factory)
