 ...
 */
public abstract class OntologyCommitPipeline<WORKFLOWDATA extends OntologyCommitPipelineData, ONTOLOGY> implements
		Committer
{
	...
	public CommitResult commit(CommitInfo commitInfo) throws CommitException {
		List<CommitObject<TermCommit>> terms = commitInfo.getTerms();
			...
			final WorkFolders workFolders) throws CommitException
	{
		...
		VersionControlAdapter scm = prepareSCM(commitInfo, data);
	 ...
	 * @throws CommitException
	 */
	protected abstract VersionControlAdapter prepareSCM(CommitInfo commitInfo, WORKFLOWDATA data)
			throws CommitException;
	 ...
	 * @throws CommitException
	 */
	protected abstract boolean applyChanges(List<CommitObject<TermCommit>> terms,
