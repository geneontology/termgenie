...
public class CommitInfo {
	...
	private final List<CommitObject<OntologyTerm>> terms;
	 ...
	 * @param password
	 */
	public CommitInfo(List<CommitObject<OntologyTerm>> terms,
	 ...
	 * @return the terms
	 */
	public List<CommitObject<OntologyTerm>> getTerms() {
		return terms;
	}
