...
public class TermGenieWebAppMPContextListener extends AbstractTermGenieContextListener {
	...
	protected IOCModule getOntologyModule() {
		...
		String repositoryURL = "https://github.com/obophenotype/mammalian-phenotype-ontology.git";
		String catalogXML = null;
		
		Map<IRI, String> mappedIRIs = new HashMap<IRI, String>();
		
		// http://purl.obolibrary.org/obo/mp.owl ->  mp/mp-edit.owl
		mappedIRIs.put(IRI.create("http://purl.obolibrary.org/obo/mp.owl"), "src/ontology/mp-edit.owl");
	...
	protected IOCModule getRulesModule() {
		...
		return new XMLDynamicRulesModule("termgenie_rules_mp.xml", useIsInferred, assertInferences, filterNonAsciiSynonyms, applicationProperties);
	}
	...
	protected IOCModule getCommitModule() {
		...
		String repositoryURL = "https://github.com/obophenotype/mammalian-phenotype-ontology.git";
		String remoteTargetFile = "src/ontology/mp-edit.owl";
		String catalogXml = null;
	...
	protected IOCModule getReviewMailHandlerModule() {
		...
		return new DefaultReviewMailHandlerModule(applicationProperties, "help@go.termgenie.org", "MP TermGenie", "smtp.lbl.gov");
	}
