...
public class LuceneOnlyClient implements OntologyTermSuggestor {
	 ...
	 * @param factory
	 */
	public LuceneOnlyClient(Collection<? extends Ontology> ontologies, Collection<OntologyTaskManager> managers, ReasonerFactory factory) {
		super();
		luceneIndices = createIndices(ontologies, managers, factory);
	}
	
	private static Map<String, BasicLuceneClient> createIndices(Collection<? extends Ontology> ontologies, Collection<OntologyTaskManager> managers, ReasonerFactory factory) {
