...
function x_formation(ontology, parent, createSynoyms) {
	...
	var definition = "The process that gives rise to the " + termname(x, ontology)
	...
	if (createSynoyms === false) {
		...
		synonyms = termgenie.synonyms(null, x, ontology, " formation", null, label);
	}
