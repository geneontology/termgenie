...
function x_structural_organization(ontology, parent, createSynoyms) {
	...
	var definition = "The process that contributes to the act of creating the structural organization of the " + termname(x, ontology)
