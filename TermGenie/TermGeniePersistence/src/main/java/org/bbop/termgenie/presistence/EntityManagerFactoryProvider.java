 ...
 * file lists among other things the enitity classes. <b>All</b> mapped entites
...
public class EntityManagerFactoryProvider {
	 ...
	 * {@link #HSQLDB}, {@link #SQLITE}, and {@link #H2}), a folder with write
	 * access, and a database name.
	 * 
	 * @param folder
	 * @param type
	 * @param db
	 * @return factory
	 * @throws RuntimeException throws an exception, if the type is unknow to
	 *             this Provider.
	 */
